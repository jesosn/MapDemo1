        ...
        OnGetPoiSearchResultListener poiListener = new OnGetPoiSearchResultListener() {
            public void onGetPoiResult(PoiResult result) {
                ...
                for (int i = 0; i < poiInfos.size(); i++) {
                    ...
                    showImageOnBaiduMap(poiInfos.get(i).location);
                }
            }
...
//构建Marker图标
    ...
    public void showImageOnBaiduMap(LatLng latLng) {
...
//在地图上添加Marker，并显示
    ...
    public void showMyLocationOnClick(View view) {
        initLocation();
